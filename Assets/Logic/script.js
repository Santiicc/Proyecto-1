...
document.getElementById("button-login").addEventListener("click", iniciarSesion);
...
var caja_trasera_login = document.querySelector(".backbox-login");
var caja_trasera_register = document.querySelector(".backbox-register");
